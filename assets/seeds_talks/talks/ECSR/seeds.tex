...
\author{\footnotesize{Charlie Rahal\\ \vspace{0.05in} LCDS and Nuffield College, University of Oxford\\\vspace{.1in}ECSR 2024}\\ \vspace{-0.15in}}
 \date{}
\frame{\titlepage
\begin{center}
\vspace{-.6in}
...
\end{figure}\pause
\begin{center}
And \emph{thanks to you for your attention and attendance!}
\end{center}
\end{frame}
...
\frametitle{Replication Materials}
	\begin{figure}[h]
		        \includegraphics[width=0.45\textwidth]{figures/frame.png}
	 \end{figure}
	\begin{center}
